...
object_draft_schematic_weapon_lightsaber_lightsaber_polearm_gen4 = object_draft_schematic_weapon_lightsaber_shared_lightsaber_polearm_gen4:new {
   ...
   resourceTypes = {"steel_duralloy", "object/weapon/melee/polearm/crafted_saber/shared_sword_lightsaber_polearm_gen3.iff", "aluminum_titanium", "petrochem_inert_polymer", "object/tangible/component/weapon/lightsaber/shared_lightsaber_module_krayt_dragon_pearl.iff", "gas_inert_culsion", "copper_polysteel"},
