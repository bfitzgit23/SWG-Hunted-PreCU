...
object_draft_schematic_weapon_lightsaber_lightsaber_two_hand_gen2 = object_draft_schematic_weapon_lightsaber_shared_lightsaber_two_hand_gen2:new {
   ...
   resourceTypes = {"metal", "object/weapon/melee/2h_sword/crafted_saber/shared_sword_lightsaber_two_handed_gen1.iff", "metal_nonferrous", "petrochem_inert", "object/tangible/component/weapon/lightsaber/shared_lightsaber_module_krayt_dragon_pearl.iff", "gas_inert_known", "metal_nonferrous"},
